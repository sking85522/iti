  ...
  <body>
    <div class="top-bar py-2">
      <div class="container d-flex flex-wrap justify-content-between align-items-center">
        <span class="small">Industrial Training Institute (ITI)</span>
        <span class="small">Phone: +91-00000-00000 | Email: info@iti.edu</span>
      </div>
    </div>
        ...
        <div class="container">
          <a class="navbar-brand d-flex align-items-center gap-2" href="/index.php">
            ...
            <div>
              ...
              <small class="text-white-50">Skilling India, Shaping Futures</small>
            </div>
          </a>
